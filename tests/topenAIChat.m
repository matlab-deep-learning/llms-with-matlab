    ...
    methods(Test)
        ...
        function constructChatWithAllNVP(testCase)
            ...
            chat = openAIChat(systemPrompt, Tools=functions, ModelName=modelName, ...
                ...
                Verbosity=verbosity, ReasoningEffort=reasoningEffort, BaseURL=baseURL);
            ...
            testCase.verifyEqual(chat.BaseURL, baseURL);
        end
        ...
        function baseURLPassedToEndpoint(testCase)
            ...
            chat = openAIChat(APIKey="this-is-not-a-real-key", BaseURL=customURL);
            chat.sendRequestFcn = @(varargin) sendRequestMock.sendRequest(varargin{:});
            ...
            testCase.verifySize(calls,[1,1]);
            sentEndpoint = calls.Inputs{4};
            testCase.verifyThat(string(sentEndpoint), ...
                StartsWithSubstring(customURL));
        end
...
invalidValuesSetters = struct( ...
    ...
    ...
    "InvalidModelNameNumeric", struct( ...
        "Property", "ModelName", ...
        "Value", 0, ...
        "Error", "MATLAB:validators:mustBeTextScalar"), ...
    ...
    ...
    "InvalidReasoningEffortType", struct( ...
        ...
        "Error", "MATLAB:validators:mustBeMember"), ...
    ...
    "InvalidBaseURLType", struct( ...
        "Property", "BaseURL", ...
        "Value", table(1), ...
        "Error", "MATLAB:validation:UnableToConvert"), ...
    ...
    "InvalidBaseURLSize", struct( ...
        "Property", "BaseURL", ...
    ...
    "MisspelledAutoTemperature", struct( ...
        ...
        "Error", "MATLAB:invalidType"), ...
    ...
    "MisspelledAutoFrequencyPenalty", struct( ...
        "Property", "FrequencyPenalty", ...
        "Value", "AUTO", ...
        "Error", "MATLAB:invalidType"));
end
...
validConstructorInput = struct( ...
    ...
    "ModelNameAsCharVector", struct( ...
        "Input",{{"APIKey","this-is-not-a-real-key","ModelName",'gpt-4o'}}, ...
        "ExpectedWarning", '', ...
        "VerifyProperties", struct( ...
                "Temperature", {"auto"}, ...
                "TopP", {"auto"}, ...
    ...
    "BaseURL", struct( ...
        "Input",{{"APIKey","this-is-not-a-real-key","BaseURL","https://custom.api.example.com/v1"}}, ...
        "ExpectedWarning", '', ...
        "VerifyProperties", struct( ...
                "Temperature", {"auto"}, ...
                "TopP", {"auto"}, ...
    ...
    "AutoHyperparameters", struct( ...
        "Input",{{"APIKey","this-is-not-a-real-key","Temperature","auto","TopP","auto","PresencePenalty","auto","FrequencyPenalty","auto"}}, ...
        "ExpectedWarning", '', ...
        "VerifyProperties", struct( ...
                "Temperature", {"auto"}, ...
                "TopP", {"auto"}, ...
    ...
    "AutoHyperparametersCharCell", struct( ...
        "Input",{{"APIKey","this-is-not-a-real-key","Temperature",'auto',"TopP",{'auto'},"PresencePenalty",{'auto'},"FrequencyPenalty",'auto'}}, ...
        "ExpectedWarning", '', ...
        "VerifyProperties", struct( ...
                "Temperature", {"auto"}, ...
...
invalidConstructorInput = struct( ...
    ...
    ...
    "InvalidBaseURLType",struct( ...
        "Input",{{ "BaseURL" table(1) }},...
        "Error","MATLAB:validation:UnableToConvert"),...
    ...
    "InvalidBaseURLSize",struct( ...
        "Input",{{ "BaseURL" ["https://a.com" "https://b.com"] }},...
        "Error","MATLAB:validation:IncompatibleSize"));
end

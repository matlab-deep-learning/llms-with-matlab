...
%
%   BaseURL                 - Base URL of backend service.
%                             "https://api.openai.com/v1" (default) | string scalar
%
    ...
    methods
        function this = openAIChat(systemPrompt, nvp)
            arguments
                ...
                nvp.BaseURL                  (1,1) string = "https://api.openai.com/v1"
            end
